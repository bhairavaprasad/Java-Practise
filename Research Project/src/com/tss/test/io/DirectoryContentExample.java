...
/**
 * In this example you'll see how to read the list of files inside a directory.
 * To get this functionality we can use the File.listFiles() method. This method
 * return an array of File object which can be either an instance of file or
 * directory.
 */
