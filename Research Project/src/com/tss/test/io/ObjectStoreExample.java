...
/**
 * This example demonstrate how to use the ObjectOutputStream and
 * ObjectInputStream to write and read serialized object. To do this below we
 * create a Book that implements java.io.Serializable interface. The book class
 * have a constructor that accept all the book detail information. To write an
 * object to a stream call the writeObject() method of the ObjectOutputStream
 * class and pass the serialized object to it. To read the object call the
...
public class ObjectStoreExample
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			//
			// We have the book saved. Now it is time to read it back and
			// display
			...
			//
			// To read the Book object use the ObjectInputStream.readObject()
			// method.
			// This method return Object type data so we need to cast it back
			// the its
