...
/**
 * The code below demonstrates the use Matcher.appendReplacement() and
 * Matcher.appendTail() methods to create a program to find and replace a sub
 * string within a string. Another solution that can be used to search and
 * replace a string can be found on the following example: How do I create a
 * string search and replace using regex?.
 */
