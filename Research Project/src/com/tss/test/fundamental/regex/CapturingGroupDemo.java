 ...
 * parentheses. For example, the regular expression (dog) creates a single group
 * containing the letters "d" "o" and "g". Regular expressions can also define
 * other capturing groups that correspond to parts of the pattern. Each pair of
 * parentheses in a regular expression defines a separate capturing group in
 * addition to the group that the whole expression defines.
 */
