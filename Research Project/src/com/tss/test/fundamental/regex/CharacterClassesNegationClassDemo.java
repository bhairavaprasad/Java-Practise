...
/**
 * A negation class is a character class that begins with a "^" metacharacter
 * which will exclude a set of defined characters within a square brackets. For
 * example the negation class h[^ao]t in the example below match only the word
 * hit and exclude the words hat and hot.
 */
public class CharacterClassesNegationClassDemo
{
	public static void main(String[] args)
	{
		...
		Matcher matcher = pattern.matcher("Wow, that hot hat will make a hit");
