...
/**
 * The example below demonstrate the Matcher.lookingAt() method to check if a
 * string starts with a pattern represented by the Pattern class.
 */
public class MatcherLookingAtExample
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Country name which have the pattern of " + pattern.pattern() + ": ");
