...
/**
 * If a try block can throw several different kind of exceptions and you want to
 * handle each exception differently, you can put several catch blocks to handle
 * it.
 */
public class MultipleCatchExample
{
	...
	/**
	 * Print the output result of divide operation by calling the divide()
	 * method.
	 * 
	 * @param numbers
	 *            integer arrays of the divided number
